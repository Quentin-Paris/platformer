class cours extends Tableau{
     ...
     * https://medium.com/@michaelwesthadley/modular-game-worlds-in-phaser-3-tiled-1-958fc7e6bbd6
     */
    preload() {
        super.preload();
        // ------pour TILED-------------
        // nos images
        this.load.image('tiles', 'assets/tiled/coursTileset.png');
        //les données du tableau qu'on a créé dans TILED
        this.load.tilemapTiledJSON('map', 'assets/tiled/cours.json');
    ...
    create() {
        ...
        this.tileset = this.map.addTilesetImage('coursTileset', 'tiles');
